...
เพียงเท่านี้ก็เรียบร้อยสำหรับการนำ Clean Architechture มาประยุกต์เพื่อใช้งานกับโปรเจ็คของเรา โพสนี้อาจจะเขียนอธิบายน้อยไปหน่อย ๆ หากผิดพลาดประการใด ขออภัย ณ ที่นั้นด้วยครับ และตัวอย่าง [Source Code](http://raboninco.com/XBm1) สามารถเข้าไป Download มาเล่นได้เลย ๆ
