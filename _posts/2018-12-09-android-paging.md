...
<br>
<br>
ซึ่งในตัวอย่างนี้เราจะใช้วิธี Network only และเพื่อให้ง่ายต่อการไล่โค้ดให้ไป clone โปรเจคนี้มาเลย ๆ >> [android-paging](http://raboninco.com/XBdS) <<

#### เริ่มกันที่ mock API ก่อน

โดยเข้าไปที่ [android-paging/server](http://raboninco.com/XBe2)
